...
print(f'{simulations} elections simulated')
print('')
print(f'Harris wins the election in {dem_win_percent:.2f}% of the simulations ({stat_dem_win_national})')
print(f'Trump wins the election in {rep_win_percent:.2f}% of the simulations ({stat_rep_win_national})')
print(f'The electoral college ties in {tie_percent:.2f}% of the simulations ({stat_tie_national})')
print('')
print(f'Arizona:')
print(f'Dem: {stat_dem_win_AZ} victories')
print(f'Rep: {stat_rep_win_AZ} victories')
print(f'Polls D: {AZ_dem_chance / 10}%, R: {AZ_rep_chance / 10}%')
print('')
print(f'Nevada:')
print(f'Dem: {stat_dem_win_NV} victories')
print(f'Rep: {stat_rep_win_NV} victories')
print(f'Polls D: {NV_dem_chance / 10}%, R: {NV_rep_chance / 10}%')
print('')
print(f'Georgia:')
print(f'Dem: {stat_dem_win_GA} victories')
print(f'Rep: {stat_rep_win_GA} victories')
print(f'Polls D: {GA_dem_chance / 10}%, R: {GA_rep_chance / 10}%')
print('')
print(f'North Carolina:')
print(f'Dem: {stat_dem_win_NC} victories')
print(f'Rep: {stat_rep_win_NC} victories')
print(f'Polls D: {NC_dem_chance / 10}%, R: {NC_rep_chance / 10}%')
print('')
print(f'Pennsylvania:')
print(f'Dem: {stat_dem_win_PA} victories')
print(f'Rep: {stat_rep_win_PA} victories')
print(f'Polls D: {PA_dem_chance / 10}%, R: {PA_rep_chance / 10}%')
print('')
print(f'Wisconsin:')
print(f'Dem: {stat_dem_win_WI} victories')
print(f'Rep: {stat_rep_win_WI} victories')
print(f'Polls D: {WI_dem_chance / 10}%, R: {WI_rep_chance / 10}%')
print('')
print(f'Michigan:')
print(f'Dem: {stat_dem_win_MI} victories')
print(f'Rep: {stat_rep_win_MI} victories')
print(f'Polls D: {MI_dem_chance / 10}%, R: {MI_rep_chance / 10}%')
print('')
...
print('How many times Harris gets each electoral college result:')
print(tabulate(table_data_dem, headers=['Electoral Votes', 'Count', 'Percentage', ''], tablefmt='simple_grid'))
print('')
print('How many times Trump gets each electoral college result:')
print(tabulate(table_data_rep, headers=['Electoral Votes', 'Count', 'Percentage', ''], tablefmt='simple_grid'))

print('')
print('')
print('Polling source: Silver Bulletin')
